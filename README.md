...
### This Repository contains the backend for One Journal. You will also need to install a copy of the frontend for this app to work. [The frontend can be found here.](https://github.com/Zio-4/one-journal-frontend)